...
_$ImageConfigurationEntityImpl _$$ImageConfigurationEntityImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$ImageConfigurationEntityImplToJson(_$ImageConfigurationEntityImpl instance) =>
    <String, dynamic>{
